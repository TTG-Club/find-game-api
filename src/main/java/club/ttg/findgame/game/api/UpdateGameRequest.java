...
/**
 * Изменение своей игры мастером. Поля и ограничения повторяют создание:
 * форма редактирования — та же самая, и правила у неё должны совпадать.
 *
 * Статус игры сюда не входит: его меняет отдельный метод завершения.
 * Идентификатор мастера берётся из access-токена, а не из тела запроса.
 */
